...
class SolicitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitation" do
    assert_difference('Solicitation.count') do
      post solicitations_url, params: { solicitation: { sala_id: @solicitation.sala_id, texto: @solicitation.texto, user_id: @solicitation.user_id } }
    end
  ...
  test "should update solicitation" do
    patch solicitation_url(@solicitation), params: { solicitation: { sala_id: @solicitation.sala_id, texto: @solicitation.texto, user_id: @solicitation.user_id } }
