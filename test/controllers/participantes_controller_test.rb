...
class ParticipantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participante" do
    assert_difference('Participante.count') do
      post participantes_url, params: { participante: { sala_id: @participante.sala_id, user_id: @participante.user_id } }
    end
  ...
  test "should update participante" do
    patch participante_url(@participante), params: { participante: { sala_id: @participante.sala_id, user_id: @participante.user_id } }
