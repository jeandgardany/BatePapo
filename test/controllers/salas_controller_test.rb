...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { adm_id: @sala.adm_id, ativa: @sala.ativa, descricao: @sala.descricao, nome: @sala.nome } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { adm_id: @sala.adm_id, ativa: @sala.ativa, descricao: @sala.descricao, nome: @sala.nome } }
